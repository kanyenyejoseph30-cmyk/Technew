...
import { Truck, QrCode, Phone, MapPin, CheckCircle2, Clock, AlertCircle, Navigation, ShieldCheck, Lock, KeyRound, LogOut, ArrowRight, ArrowLeft, Sparkles, Store } from 'lucide-react';
      ...
      <div className="max-w-xl mx-auto px-4 py-8 sm:py-12 space-y-4">
        {onGoToShop && (
          <div className="flex items-center justify-start">
            <button
              id="btn-back-to-shop-from-driver-auth"
              onClick={onGoToShop}
              type="button"
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 animate-in fade-in">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 bg-white p-4 rounded-2xl border border-stone-200 shadow-xs">
        <div className="flex items-center gap-2">
          {onGoToShop && (
            <button
              id="btn-back-to-shop-driver-header"
              onClick={onGoToShop}
              type="button"
        ...
        <div className="flex items-center gap-3">
          <span className="text-xs text-stone-500 hidden sm:inline">
            Session Livreur : <strong className="text-stone-800">{driverName}</strong>
          </span>
          <button
              ...
              <div className="space-y-2 pt-3 text-xs text-stone-700">
                ...
                <div className="flex justify-between items-center text-[11px] text-stone-500 pt-1">
                  ...
                  <span className="font-bold text-stone-900">
                    ${order.totalAmount} ({formatCDF(order.totalAmount, exchangeRate)})
                  </span>
                </div>
              </div>
            </div>
